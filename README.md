...
To benefit from its features during this course, you should install the following extensions. This can be done directly from the editor. If you use the [VS Code Dev Containers](#vs-code-dev-containers), the plugin are installed automatically.
